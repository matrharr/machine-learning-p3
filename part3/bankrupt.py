...
with open('part2/rand-proj-bank.npy', 'rb') as f:
    file = np.load(f)
    features.append([file, 'rand-proj'])

# with open('part2/lda-bankrupt.npy', 'rb') as f:
#     file = np.load(f)
...
for feature in features:
    ...
    # plt.show()
    # plt.savefig(f'figures/part3_kmeans_bank_{dim_red_name}_scatter.png')
    ...
    with open(f'part3/kmeans_bank_{dim_red_name}.npy', 'wb') as f:
        np.save(f, kmeans_data)
    
    # slow
    # all pairs
    # sns_pair = sns.pairplot(og_data,hue='labels')
    # sns_pair.savefig(f'figures/part3_kmeans_bank_{dim_red_name}.png')
...
for feature in features:
    ...
    # plt.show()
    plt.savefig(f'figures/part3_gm_bank_{dim_red_name}.png')

    with open(f'part3/gm_bank_{dim_red_name}.npy', 'wb') as f:
        np.save(f, gm_data)
