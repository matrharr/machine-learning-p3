...
with open('part3/kmeans_brain_pca.npy', 'rb') as f:
    file = np.load(f)
    features.append([file, 'kmeans_pca'])

with open('part3/kmeans_brain_ica.npy', 'rb') as f:
    file = np.load(f)
    features.append([file, 'kmeans_ica'])

with open('part3/kmeans_brain_rand-proj.npy', 'rb') as f:
    file = np.load(f)
...
with open('part3/gm_brain_ica.npy', 'rb') as f:
    file = np.load(f)
...
for feature in features:
    ...
    # plt.show()
    fig.savefig(f'figures/part5_nn_brain_{cluster_dimred_name}_learning_curve')
